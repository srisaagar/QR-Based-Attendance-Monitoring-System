      ...
      <section className="programs-section">
        <div className="container">
          ...
          <div className="program-cards">
            ...
            <div className="card">
              <img
                src="https://lh3.googleusercontent.com/gps-cs-s/AC9h4nrFXr3IoRUFxoAYps2Tf-5fXCrLuTcdFBBF8KFgYDqEBaJVVSjULsWgYZbvvL7OItgP-fEO7dmWtAs-u6f3zkd6_VE8cNYjflMlET_hb3vbI2qEdei8hHp5zd1d3tmDCaE3Qcyn=s1360-w1360-h1020-rw"
                alt="Architecture"
              />
